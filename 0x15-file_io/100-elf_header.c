...
/**
 * print_class - functio that prints the class of an ELF header.
...
/**
 * print_data - funstion that prints the data of an ELF header.
 * @e_ident: A pointer to an array containing the ELF class.
 */
void print_data(unsigned char *e_ident)
{
...
/**
 * print_type - function that prints that type of an ELF header.
 * @e_type: ELF type.
